...
class Booking
{
     ...
     * @ORM\Column(type="datetime")
     * @Assert\Date(message="Date KO")
     * @Assert\GreaterThan(propertyPath="startDate", message="La date de départ doit être plus grande que la date d'arrivé.")
     */
    private $endDate;
    ...
    public function isBookableDates(){
        ...
        // 2) Il faut comparer les dates choisies avec celle qui sont impossible
